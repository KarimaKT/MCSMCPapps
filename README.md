...
| [docs/](docs/) | [BUILD-GUIDE.md](docs/BUILD-GUIDE.md) (manual / no-AI walkthrough), [MAKER-CONFIG.md](docs/MAKER-CONFIG.md) (rebrand & identity), [CAPABILITIES.md](docs/CAPABILITIES.md) (what the runtime can do + demo script), [IDs.md](docs/IDs.md), [AZURE-SUBSCRIPTION.md](docs/AZURE-SUBSCRIPTION.md), [PROGRESS.md](docs/PROGRESS.md). |
