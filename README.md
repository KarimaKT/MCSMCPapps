...
| [docs/](docs/) | [BUILD-GUIDE.md](docs/BUILD-GUIDE.md) (manual / no-AI walkthrough), [AUTH-ARCHITECTURE.md](docs/AUTH-ARCHITECTURE.md) (six actors, four boundaries), [MAKER-CONFIG.md](docs/MAKER-CONFIG.md) (rebrand & identity), [CAPABILITIES.md](docs/CAPABILITIES.md) (what the runtime can do + demo script), [ARCHITECTURE-CENTER-DRAFT.md](docs/ARCHITECTURE-CENTER-DRAFT.md) (Learn-style article), [IDs.md](docs/IDs.md), [AZURE-SUBSCRIPTION.md](docs/AZURE-SUBSCRIPTION.md), [PROGRESS.md](docs/PROGRESS.md), [IDEAS/](docs/IDEAS/) (parking lot). |
