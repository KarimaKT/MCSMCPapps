...
| 5j | Single-file widget bundle | ⏳ Planned | Replace iframe-of-SWA with single-file React bundle inlined into widget HTML via `vite-plugin-singlefile`. Requires React migration of webchat-ui and adoption of `CopilotStudioWebChat.createConnection()` OOB transport. ~1 day of work. |
